...
<div class="container">
  ...
  <div class="keyboard-hint">
    💡 Tip: Use arrow keys (← →), Page Up/Page Down, or swipe left/right on mobile to navigate
  </div>
...
slideViewer.addEventListener('touchstart', function(event) {{
  touchStartX = event.changedTouches[0].screenX;
}}, {{ passive: true }});

slideViewer.addEventListener('touchend', function(event) {{
...
updateSlide();
    ...
    print(f"✓ Updated {name}/index.html")

print(f"\n✓ Updated all {len(all_presentations)} presentation viewer pages")
print("✓ Missing slides will now show a placeholder instead of broken images")
