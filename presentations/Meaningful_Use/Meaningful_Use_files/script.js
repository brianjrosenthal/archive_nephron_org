...
var ENDSHOW_MESG="End of slide show, click to exit.", SCREEN_MODE="Frames", gIsEndShow=0, NUM_VIS_SLDS=62, SCRIPT_HREF="script.js", FULLSCR_HREF="fullscreen.htm";
...
var gDocTable = new Array(
   new hrefList("slide0125.htm", 1, 1),
   new hrefList("slide0126.htm", 1, 2),
   new hrefList("slide0127.htm", 1, 3),
   new hrefList("slide0128.htm", 1, 4),
   new hrefList("slide0129.htm", 1, 5),
   new hrefList("slide0130.htm", 1, 6),
   new hrefList("slide0131.htm", 1, 7),
   new hrefList("slide0132.htm", 1, 8),
   new hrefList("slide0133.htm", 1, 9),
   new hrefList("slide0134.htm", 1, 10),
   new hrefList("slide0135.htm", 1, 11),
   new hrefList("slide0136.htm", 1, 12),
   new hrefList("slide0137.htm", 1, 13),
   new hrefList("slide0138.htm", 1, 14),
   new hrefList("slide0139.htm", 1, 15),
   new hrefList("slide0140.htm", 1, 16),
   new hrefList("slide0141.htm", 1, 17),
   new hrefList("slide0142.htm", 1, 18),
   new hrefList("slide0143.htm", 1, 19),
   new hrefList("slide0144.htm", 1, 20),
   new hrefList("slide0145.htm", 1, 21),
   new hrefList("slide0146.htm", 1, 22),
   new hrefList("slide0147.htm", 1, 23),
   new hrefList("slide0148.htm", 1, 24),
   new hrefList("slide0149.htm", 1, 25),
   new hrefList("slide0150.htm", 1, 26),
   new hrefList("slide0151.htm", 1, 27),
   new hrefList("slide0152.htm", 1, 28),
   new hrefList("slide0153.htm", 1, 29),
   new hrefList("slide0154.htm", 1, 30),
   new hrefList("slide0155.htm", 1, 31),
   new hrefList("slide0156.htm", 1, 32),
   new hrefList("slide0157.htm", 1, 33),
   new hrefList("slide0158.htm", 1, 34),
   new hrefList("slide0159.htm", 1, 35),
   new hrefList("slide0160.htm", 1, 36),
   new hrefList("slide0161.htm", 1, 37),
   new hrefList("slide0162.htm", 1, 38),
   new hrefList("slide0163.htm", 1, 39),
   new hrefList("slide0164.htm", 1, 40),
   new hrefList("slide0165.htm", 1, 41),
   new hrefList("slide0166.htm", 1, 42),
   new hrefList("slide0167.htm", 1, 43),
   new hrefList("slide0168.htm", 1, 44),
   new hrefList("slide0169.htm", 1, 45),
   new hrefList("slide0170.htm", 1, 46),
   new hrefList("slide0171.htm", 1, 47),
   new hrefList("slide0172.htm", 1, 48),
   new hrefList("slide0173.htm", 1, 49),
   new hrefList("slide0174.htm", 1, 50),
   new hrefList("slide0175.htm", 1, 51),
   new hrefList("slide0176.htm", 1, 52),
   new hrefList("slide0177.htm", 1, 53),
   new hrefList("slide0178.htm", 1, 54),
   new hrefList("slide0179.htm", 1, 55),
   new hrefList("slide0180.htm", 1, 56),
   new hrefList("slide0181.htm", 1, 57),
   new hrefList("slide0182.htm", 1, 58),
   new hrefList("slide0183.htm", 1, 59),
   new hrefList("slide0184.htm", 1, 60),
   new hrefList("slide0185.htm", 1, 61),
   new hrefList("slide0186.htm", 1, 62)
);
...
var g_baseURL = gtmpstr.substr(0, gtmpstr.lastIndexOf("/") ) + "/" + "Meaningful_Use_files";
var g_showoutline = 1;
  ...
  if ( (msie || isnav ) && ( (os < 0 && ver >= 4 ) || ( os >= 0 && ver >= 5 ) || (os >=0 && msie < 0 && ver >= 4 ) )  ){
	if ( msie >= 0 )  {
		if ( isIEFiles > 0 )
			...
			window.location.replace(  "Meaningful_Use_files/error.htm" );
	}
	else {
