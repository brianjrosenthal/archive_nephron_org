...
var gDocTable = new Array(
   new hrefList("slide0083.htm", 1, 1),
   new hrefList("slide0084.htm", 1, 2),
   new hrefList("slide0085.htm", 1, 3),
   new hrefList("slide0086.htm", 1, 4),
   new hrefList("slide0087.htm", 1, 5),
   new hrefList("slide0088.htm", 1, 6),
   new hrefList("slide0089.htm", 1, 7),
   new hrefList("slide0090.htm", 1, 8),
   new hrefList("slide0091.htm", 1, 9),
   new hrefList("slide0092.htm", 1, 10),
   new hrefList("slide0093.htm", 1, 11),
   new hrefList("slide0094.htm", 1, 12),
   new hrefList("slide0095.htm", 1, 13),
   new hrefList("slide0096.htm", 1, 14),
   new hrefList("slide0097.htm", 1, 15),
   new hrefList("slide0098.htm", 1, 16),
   new hrefList("slide0099.htm", 1, 17),
   new hrefList("slide0100.htm", 1, 18),
   new hrefList("slide0101.htm", 1, 19),
   new hrefList("slide0102.htm", 1, 20),
   new hrefList("slide0103.htm", 1, 21),
   new hrefList("slide0104.htm", 1, 22),
   new hrefList("slide0105.htm", 1, 23),
   new hrefList("slide0106.htm", 1, 24),
   new hrefList("slide0107.htm", 1, 25),
   new hrefList("slide0108.htm", 1, 26),
   new hrefList("slide0109.htm", 1, 27),
   new hrefList("slide0110.htm", 1, 28),
   new hrefList("slide0111.htm", 1, 29),
   new hrefList("slide0112.htm", 1, 30),
   new hrefList("slide0113.htm", 1, 31),
   new hrefList("slide0114.htm", 1, 32),
   new hrefList("slide0115.htm", 1, 33),
   new hrefList("slide0116.htm", 1, 34),
   new hrefList("slide0117.htm", 1, 35),
   new hrefList("slide0118.htm", 1, 36),
   new hrefList("slide0119.htm", 1, 37),
   new hrefList("slide0120.htm", 1, 38),
   new hrefList("slide0121.htm", 1, 39),
   new hrefList("slide0122.htm", 1, 40),
   new hrefList("slide0123.htm", 1, 41)
);
...
var g_baseURL = gtmpstr.substr(0, gtmpstr.lastIndexOf("/") ) + "/" + "Flenniken_files";
var g_showoutline = 1;
  ...
  if ( (msie || isnav ) && ( (os < 0 && ver >= 4 ) || ( os >= 0 && ver >= 5 ) || (os >=0 && msie < 0 && ver >= 4 ) )  ){
	if ( msie >= 0 )  {
		if ( isIEFiles > 0 )
			...
			window.location.replace(  "Flenniken_files/error.htm" );
	}
	else {
